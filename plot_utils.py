...
def plot_replay(gridworld, replay_sequence, ax=None, figsize=(12, 12), highlight_last=False):
	"""
...
def plot_need_gain(gridworld, transitions, need, gain, MEVB, specials=None, params=None):
	# Dumb input validation
	if params is None:
		params = {}
